...
public:
    ...
    void draw(Window *window) const override
    {
        ...
        getShaderProgram().uniformMatrix4fv("M", glm::value_ptr(M));
...
protected:
    ...
    virtual int getVertexArrayLength() const { return vertexArray.length; }
    virtual const ShaderProgram &getShaderProgram() const { return shaderProgram; }
