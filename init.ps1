...
$webClient.DownloadFile("https://onedrive.live.com/download?cid=F7B2E5ED214ED032&resid=F7B2E5ED214ED032%214910&authkey=ANa6TuYeKnGai4A", "$env:TEMP\glad.zip")
...
$webClient.DownloadFile("https://onedrive.live.com/download?cid=F7B2E5ED214ED032&resid=F7B2E5ED214ED032%214909&authkey=ADt8ZYAVrLtcSyY", "$env:TEMP\penguin.zip")
...
$webClient.DownloadFile("https://onedrive.live.com/download?cid=F7B2E5ED214ED032&resid=F7B2E5ED214ED032%214929&authkey=AMzTuQnU0EVMqOo", "$env:TEMP\slime.zip")
...
$webClient.DownloadFile("https://onedrive.live.com/download?cid=F36537D7A4297BE4&resid=F36537D7A4297BE4%21835&authkey=AIFCo9mbj_zDv6E", "$env:TEMP\9mm.zip")
...
Copy-Item -Path ".\src\config\config.default.json" -Destination ".\bin\Release" -ErrorAction SilentlyContinue -Force -Recurse
Rename-Item -Path ".\bin\Release\config.default.json" -NewName "config.json" -ErrorAction SilentlyContinue -Force
Write-Host "Done"
